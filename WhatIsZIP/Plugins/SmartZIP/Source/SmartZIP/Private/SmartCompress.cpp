...
SmartZIP::FCompressAssist::FCompressAssist(TArray<uint8> &InData)
	:Data(InData)
{

}

bool SmartZIP::FCompressAssist::Compress(const TArray<uint8> &UncompressedData)
{
...
bool SmartZIP::FCompressAssist::Decompress(const TArray<uint8> &CompressedData)
{
