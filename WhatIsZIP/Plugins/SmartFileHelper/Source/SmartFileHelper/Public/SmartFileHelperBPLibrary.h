...
#include "SmartFileHelperBPLibrary.generated.h"

/*-----------------------------------------------------------------------------
	USmartFileHelperBPLibrary
-----------------------------------------------------------------------------*/
UCLASS()
class USmartFileHelperBPLibrary : public UObject
{
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SmartFileHelper")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SmartFileHelper")
	static bool LoadFileToString(FString& Result, const FString &Filename, ESmartHashOptions VerifyFlags);
	...
	*/
	UFUNCTION(BlueprintCallable,Category = "SmartFileHelper")
	static bool LoadFileToStringArray(TArray<FString>& Result, const FString &Filename, ESmartHashOptions VerifyFlags);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SmartFileHelper")
	static bool SaveStringToFile(const FString& String, const FString &Filename, ESmartEncodingOptions EncodingOptions = ESmartEncodingOptions::AutoDetect, int32 WriteFlags = 0);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SmartFileHelper")
	static bool SaveStringArrayToFile(const TArray<FString>& Lines, const FString &Filename, ESmartEncodingOptions EncodingOptions = ESmartEncodingOptions::AutoDetect, int32 WriteFlags = 0);
	...
	*	Intended for use in Smart text parsing actions
	*
