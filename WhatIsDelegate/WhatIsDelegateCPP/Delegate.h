...
public:
	...
	{
		this->emplace_back(TDelegate());//添加
...
#define DEFINITION_SIMPLE_MULTICAST_DELEGATE(DefinitionName, Return,...) class DefinitionName : public FMulticastDelegate<Return, __VA_ARGS__> {};
